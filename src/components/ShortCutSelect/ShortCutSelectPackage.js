...
const ShortCutSelectSupplierGroup = ({
  ...
  const [visibleAddPackage, setVisibleAddPackage] = useState(false);
    ...
    <React.Fragment>
      <div style={{ display: 'inline-flex', width: '100%' }}>
        ...
        <Tooltip
          title={
            !isMobile &&
            intl.formatMessage({ id: 'app.packages.quickCreate.header' })
          }
        >
          <Button
            style={{
            ...
            type="ghost"
            icon={<PlusOutlined />}
            onClick={() => setVisibleAddPackage(!visibleAddPackage)}
          />
        </Tooltip>
      </div>
      <Spin spinning={loading}>
        <Modal
          ...
          title={intl.formatMessage({
            id: 'app.packages.quickCreate.header',
          })}
          visible={visibleAddPackage}
          onOk={handleSubmit}
          width={isMobile ? '100%' : '520px'}
          onCancel={() => setVisibleAddPackage(false)}
          cancelText={
            <React.Fragment>
          ...
          <FormItem
            ...
            label={
              <span>
                ...
                {intl.formatMessage({ id: 'app.packages.list.col0' })}
              </span>
            }
            rules={[
              {
