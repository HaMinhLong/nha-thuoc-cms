...
const ShortCutSelectSupplierGroup = ({
  ...
  const [visibleAddUnit, setVisibleAddUnit] = useState(false);
    ...
    <React.Fragment>
      <div style={{ display: 'inline-flex', width: '100%' }}>
        ...
        <Tooltip
          title={
            !isMobile &&
            intl.formatMessage({ id: 'app.unit.quickCreate.header' })
          }
        >
          <Button
            style={{
            ...
            type="ghost"
            icon={<PlusOutlined />}
            onClick={() => setVisibleAddUnit(!visibleAddUnit)}
          />
        </Tooltip>
      </div>
      <Spin spinning={loading}>
        <Modal
          ...
          title={intl.formatMessage({
            id: 'app.unit.quickCreate.header',
          })}
          visible={visibleAddUnit}
          onOk={handleSubmit}
          width={isMobile ? '100%' : '520px'}
          onCancel={() => setVisibleAddUnit(false)}
          cancelText={
            <React.Fragment>
          ...
          <FormItem
            ...
            label={
              <span>
                ...
                {intl.formatMessage({ id: 'app.unit.list.col0' })}
              </span>
            }
            rules={[
              {
