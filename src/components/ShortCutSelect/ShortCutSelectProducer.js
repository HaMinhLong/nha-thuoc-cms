...
import ProducerGroupSelect from '../Common/ProducerGroupSelect';
...
const ShortCutSelectProducer = ({
  ...
  const [producerGroupId, setProducerGroupId] = useState('');
    ...
    <React.Fragment>
      <div style={{ display: 'inline-flex', width: '100%' }}>
        ...
        <Tooltip
          title={
            !isMobile &&
            intl.formatMessage({ id: 'app.producer.quickCreate.header' })
          }
        >
          <Button
            style={{
      ...
      <Spin spinning={loading}>
        <Modal
          ...
          title={intl.formatMessage({
            id: 'app.producer.quickCreate.header',
          })}
        ...
        >
          <FormItem
            ...
            label={
              <span>
                ...
                {intl.formatMessage({ id: 'app.producer.list.col1' })}
              </span>
            }
            rules={[
              {
          ...
          >
            <ProducerGroupSelect
              ...
              onChange={(value) => setProducerGroupId(value)}
            />
          </FormItem>
          <FormItem
            labelCol={{ span: 24 }}
            ...
            label={
              <span>
                <span style={{ color: 'red' }}>*</span>&nbsp;
                {intl.formatMessage({ id: 'app.producer.list.col0' })}
              </span>
            }
            rules={[
              {
          ...
          <FormItem
            ...
            label={
              <span>
                <span style={{ color: 'red' }}>*</span>&nbsp;
                {intl.formatMessage({ id: 'app.producer.list.col2' })}
              </span>
            }
            rules={[
              {
