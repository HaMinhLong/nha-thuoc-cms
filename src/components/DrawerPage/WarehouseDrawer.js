      ...
      title={
        <h3 style={{ color: '#196CA6', marginBottom: '0px' }}>
          {data.id
            ...
            : intl.formatMessage({ id: 'app.warehouse.create.header' })}
        </h3>
      }
      placement="right"
        ...
        >
          ...
          >
            <Input
              placeholder={intl.formatMessage({
                id: 'app.warehouse.list.warehouseName',
              })}
            />
          </FormItem>
          ...
          <FormItem
            ...
            label={
              <span>
                <span style={{ color: 'red' }}>*</span>&nbsp;
                <FormattedMessage id="app.warehouse.list.col2" />
              </span>
            }
            rules={[
              {
          ...
          >
            <ProvinceSelect
              placeholder={intl.formatMessage({
                id: 'app.warehouse.list.province',
              })}
              allowClear
              onChange={(value) => {
            ...
            {({ getFieldValue }) => (
              <FormItem
                ...
                label={
                  <span>
                    <span style={{ color: 'red' }}>*</span>&nbsp;
                    <FormattedMessage id="app.warehouse.list.col3" />
                  </span>
                }
                rules={[
                  {
              ...
              >
                <DistrictSelect
                  placeholder={intl.formatMessage({
                    id: 'app.warehouse.list.district',
                  })}
                  filter
            ...
            {({ getFieldValue }) => (
              <FormItem
                ...
                label={
                  <span>
                    <span style={{ color: 'red' }}>*</span>&nbsp;
                    <FormattedMessage id="app.warehouse.list.col4" />
                  </span>
                }
                rules={[
                  {
          ...
          <FormItem
            ...
            label={
              <span>
                <FormattedMessage id="app.warehouse.list.col5" />
              </span>
            }
            rules={[
              {
