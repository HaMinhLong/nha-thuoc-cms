...
const UserGroupSelect = ({
  ...
  const fetch = (
    ...
    const tfilter = {
      userId: userId,
      healthFacilityName: searchValue,
      status: 1,
    };
