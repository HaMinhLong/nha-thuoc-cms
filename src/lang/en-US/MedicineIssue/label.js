module.exports = {
  ...
  'app.medicineIssue.list': 'List of sales orders',

  // Tiêu đề các cột
  'app.medicineIssue.list.col0': 'Receipt code',
  'app.medicineIssue.list.col1': 'Payment method',
  'app.medicineIssue.list.col2': 'Mobile',
  'app.medicineIssue.list.col3': 'Customer name',
  'app.medicineIssue.list.col4': 'Seller',
  'app.medicineIssue.list.col5': 'Debit',
  'app.medicineIssue.list.col6': 'Description',
  'app.medicineIssue.list.col7': 'Status',
  ...
  'app.medicineIssue.search.col1': 'Search by payment method',
  'app.medicineIssue.search.col2': 'Search by customer',
  'app.medicineIssue.search.col4': 'Search by debit',

  // placeholder
  'app.medicineIssue.list.name': 'Enter receipt code',
  'app.medicineIssue.list.paymentMethod': 'Select payment method',
  'app.medicineIssue.list.mobile':
