module.exports = {
  ...
  'app.medicineIssue.list': 'Danh sách đơn bán',

  // Tiêu đề các cột
  'app.medicineIssue.list.col0': 'Mã phiếu',
  'app.medicineIssue.list.col1': 'PT thanh toán',
  'app.medicineIssue.list.col2': 'Số điện thoại',
  'app.medicineIssue.list.col3': 'Tên khách hàng',
  'app.medicineIssue.list.col4': 'Người bán',
  'app.medicineIssue.list.col5': 'Công nợ',
  'app.medicineIssue.list.col6': 'Ghi chú',
  'app.medicineIssue.list.col7': 'Trạng thái',
  ...
  'app.medicineIssue.search.col1': 'Tìm kiếm theo pt thanh toán',
  'app.medicineIssue.search.col2': 'Tìm kiếm theo khách hàng',
  'app.medicineIssue.search.col4': 'Tìm kiếm theo công nợ',

  // placeholder
  'app.medicineIssue.list.name': 'Nhập mã phiếu',
  'app.medicineIssue.list.paymentMethod': 'Chọn phương thức thanh toán',
