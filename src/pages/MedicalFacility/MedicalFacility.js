...
import {
  medicalFacility,
  filter,
} from '../../features/medicalFacility/medicalFacilitySlice';
...
import MedicalFacilityDrawer from '../../components/DrawerPage/MedicalFacilityDrawer';
...
const MedicalFacility = ({ isMobile, intl, headerPage }) => {
  let { id } = useParams();
  const userGroupId = localStorage.getItem('userGroupId');
  const dispatch = useDispatch();
  const list = useSelector(medicalFacility);
  ...
  const getList = () => {
    ...
    let params = {
      ...
      attributes: 'id,medicalFacilityName,email,mobile,status,createdAt',
    };
    let values = {};
  ...
  const handleStatus = (value, row) => {
    ...
    dispatch({
      type: 'medicalFacility/updateStatus',
      payload: {
        id: row.id,
        params: item,
      },
  ...
  const handleTableChange = (pagination, filters, sorter) => {
    ...
    const queryName = {
      medicalFacilityName:
        queryFilter.medicalFacilityName &&
        queryFilter.medicalFacilityName.trim(),
    ...
    if (
      ...
      delete queryName.medicalFacilityName;
    }
  ...
  const handleSearch = (values) => {
    ...
    if (!(values.medicalFacilityName && values.medicalFacilityName.trim())) {
      delete queryName.medicalFacilityName;
    }
  ...
  const renderForm = () => {
    ...
    return (
      <Form
        ...
        initialValues={{
          medicalFacilityName: filter.medicalFacilityName || '',
        ...
        <Row gutter={{ md: 0, lg: 8, xl: 16 }}>
          <Col xs={24} md={12} xl={8}>
            <FormItem
              ...
              label={<FormattedMessage id="app.medicalFacility.list.col1" />}
              {...formItemLayout}
            >
              <Input
                placeholder={intl.formatMessage({
                  id: 'app.medicalFacility.search.col0',
                })}
                size="small"
              />
            </FormItem>
          ...
          <Col xs={24} md={12} xl={8}>
            <FormItem
              name="provinceId"
              label={<FormattedMessage id="app.medicalFacility.list.col4" />}
              {...formItemLayout}
            >
              <ProvinceSelect
                placeholder={intl.formatMessage({
                  id: 'app.medicalFacility.search.col2',
                })}
                allowClear
                size="small"
              />
  ...
  const columns = [
    ...
    {
      dataIndex: 'medicalFacilityName',
      name: 'medicalFacilityName',
      width: isMobile ? 100 : '10%',
      title: <FormattedMessage id="app.medicalFacility.list.col1" />,
      align: 'left',
      sorter: () => {},
      fixed: isMobile,
    },
    {
      ...
      title: <FormattedMessage id="app.medicalFacility.list.col2" />,
      align: 'center',
      sorter: () => {},
    },
    {
      ...
      name: 'mobile',
      width: isMobile ? 150 : '15%',
      title: <FormattedMessage id="app.medicalFacility.list.col3" />,
      align: 'center',
      sorter: () => {},
    },
    {
      ...
      name: 'province',
      width: isMobile ? 150 : '15%',
      title: <FormattedMessage id="app.medicalFacility.list.col4" />,
      align: 'center',
      sorter: () => {},
    ...
    },
    {
      dataIndex: 'status',
      name: 'status',
      title: <FormattedMessage id="app.medicalFacility.list.col8" />,
      align: 'center',
    ...
    <>
      {permissions ? (
        <>
          {headerPage}
          <HeaderContent
            title={<FormattedMessage id="app.medicalFacility.list.header" />}
            action={
              <React.Fragment>
                  ...
                  {permissions.isAdd && (
                    <Tooltip
                      title={
                        !isMobile &&
                        intl.formatMessage({
                          id: 'app.medicalFacility.create.header',
                        })
                      }
                    >
                      <Button
      ...
      <MedicalFacilityDrawer
        ...
        titleDrawer={intl.formatMessage({
          id: 'app.medicalFacility.list.title',
        })}
        dataEdit={dataEdit}
        getList={getList}
      />
